...
public class PatientReferralActivityFinal extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_patient_referral_activity_final);
        ...
        referralStatus = intent.getIntExtra("referralStatus", 1);
    ...
    public void save(){
        ...
        item.pushed = false;
        item.referralStatus = ReferralStatus.get(referralStatus);
