 ...
 */
public class PrimaryCareGiverAdapter extends ArrayAdapter<Patient> {

    private Context context;
    private ArrayList<Patient> list;
    TextView name;

    public PrimaryCareGiverAdapter(Context context, ArrayList<Patient> list){
    ...
    public View getView(int pos, View convertView, ViewGroup parent) {
        ...
        /*if(patient.pfirstName == null && patient.plastName == null){
            name.setText("");
        }else{
            name.setText(patient.pfirstName + " " + patient.plastName);
        }*/
        return newView;
    }
