 ...
 */
public class ChangePatientStatusAdapter extends ArrayAdapter<Patient> {

    private Context context;
    private ArrayList<Patient> list;
    TextView name;

    public ChangePatientStatusAdapter(Context context, ArrayList<Patient> list){
    ...
    public View getView(int pos, View convertView, ViewGroup parent) {
        ...
        /*if(patient.status != null){
            name.setText(pos + 1 + ". Status: " + patient.status.getName());
        }else{
            name.setText("");
        }*/
        return newView;
