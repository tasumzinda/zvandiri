 ...
 */
public class TransferPatientFacilityAdapter extends ArrayAdapter<Patient> {

    private Context context;
    private ArrayList<Patient> list;
    TextView name;

    public TransferPatientFacilityAdapter(Context context, ArrayList<Patient> list){
    ...
    public View getView(int pos, View convertView, ViewGroup parent) {
        ...
        /*if(patient.primaryClinic == null){
            name.setText("");
        }else{
            name.setText(patient.primaryClinic.name);
        }*/
        return newView;
    }
